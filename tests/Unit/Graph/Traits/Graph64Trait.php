...
/**
 * Внедрение методов для построения и просмотра обхода графа с 64 вершинами "шахматная доска"
 */
trait Graph64Trait
{
    /**
     * Получение вершин для построения графа с 64 вершинами "шахматная доска"
     *
     * @return array
     */
    ...
    /**
     * Псевдографическое отображение обхода графа с 64 вершинами "шахматная доска"
     *
     * @param array $path
